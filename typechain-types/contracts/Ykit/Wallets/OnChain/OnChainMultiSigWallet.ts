...
export interface OnChainMultiSigWalletInterface extends utils.Interface {
  functions: {
...
export interface OnChainMultiSigWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnChainMultiSigWalletInterface;
