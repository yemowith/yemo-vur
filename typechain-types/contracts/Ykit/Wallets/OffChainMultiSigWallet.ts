...
export interface OffChainMultiSigWalletInterface extends utils.Interface {
  functions: {
...
export interface OffChainMultiSigWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OffChainMultiSigWalletInterface;
