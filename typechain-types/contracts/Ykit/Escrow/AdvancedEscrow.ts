...
export interface AdvancedEscrowInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "balanceOfDeposits(address)": FunctionFragment;
    "deposit(uint256,string)": FunctionFragment;
    "depositToken()": FunctionFragment;
    "emergencyWithdraw()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getVaultItem(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "balanceOfDeposits",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface AdvancedEscrow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdvancedEscrowInterface;
