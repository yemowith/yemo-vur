...
export interface SessionManagerTestInterface extends utils.Interface {
  functions: {
...
export interface SessionManagerTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SessionManagerTestInterface;
